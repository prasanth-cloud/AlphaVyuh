...
export const agentLanes: AgentLane[] = [
  {
    ...
    status: "active",
    currentWork: "Runs Professional Access cleanup through issue -> agent roster -> PR -> validation loops; latest loop shipped PRs #190-#194.",
  ...
  },
  {
    ...
    autonomy: "Level 2",
    status: "watching",
    currentWork: "Keeps visible product copy, active planning docs, and authenticated-flow labels on Professional Access language while data recovery stays focused on Railway hosting.",
  ...
  },
  {
    ...
    autonomy: "Level 3",
    status: "watching",
    currentWork: "Protects Professional Access copy, recovery handoff credentials, Railway workflow proof, data-recovery checks, checker self-tests, signed-in smoke, auth, scanner, watchlist, chart, journal, layout, perf, and agent PR gates.",
...
export const shippedAgentPrs: ShippedAgentPr[] = [
  ...
  },
  {
    ...
    productImpact: "Operator-only surfaces now stay aligned with Professional Access language instead of drifting behind public copy guards.",
  },
  {
    pr: "#189",
  ...
  },
  {
    ...
    productImpact: "The launch gate now exercises the same guard logic that protects Professional Access copy and production recovery evidence.",
  },
  {
    pr: "#185",
  ...
  },
  {
    ...
    title: "Guard Professional Access checklist copy",
    agent: "Product Copy + Release Guard",
    merged: "2026-05-19",
    notes: "Cleaned the active Professional Access launch checklist and added posture guards for old broker-era and provider-trial wording.",
    productImpact: "Active operator checklists can no longer quietly reintroduce old beta framing before a launch batch.",
  },
  {
    pr: "#183",
