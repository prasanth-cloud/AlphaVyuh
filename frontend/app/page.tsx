          ...
          <section className="av-hero">
            <div className="av-hero-grid">
              <div>
                ...
                <p className="av-sub">
                  AlphaVyuh brings scanner, watchlist, chart review, trade planning, journaling, and post-trade review
                  into one trading operating system so serious retail traders stop leaking context between tools.
                </p>
                ...
                <div className="av-proof">
                  ...
                  <div className="av-proof-chip">Scanner, watchlist, chart, plan, and journal stay connected.</div>
              ...
              <div className="av-panel">
                <div className="av-panel-head">
                  ...
                  <div className="av-panel-badge">EOD market context + chart + journal logic</div>
                </div>
                    ...
                    <div className="av-chart">
                      <div className="av-chart-top">
                        <div>
                          ...
                          <div className="av-chart-price">EMA stack, active levels, trade plan, journal handoff</div>
                        </div>
                        <div className="av-chart-actions">
                          <span className="av-chip">Levels</span>
                          <span className="av-chip">RS context</span>
                      ...
                      <div className="av-chart-lower">
                        <div className="av-stat-row">
                          ...
                          <div className="av-stat">
                            <div className="label">Plan state</div>
                        ...
                        <div className="av-review-card">
                          ...
                          <div className="av-review-list">
                            <div className="av-review-item">
                              <strong>Plan stayed attached to context</strong>
                              <span>The setup, chart levels, and trade record stay linked instead of splitting across tools.</span>
                            </div>
                            <div className="av-review-item">
          ...
          <section className="av-footer-cta" id="launch">
            <div>
              ...
              <div className="av-section-copy" style={{ maxWidth: 620 }}>
                Open the platform, build a shortlist fast, and keep the full decision chain inside one connected product. Market data surfaces should always show their source and freshness.
              </div>
            </div>
            <div className="av-nav-actions">
              <Link href="/login" className="av-btn-secondary">Sign in</Link>
