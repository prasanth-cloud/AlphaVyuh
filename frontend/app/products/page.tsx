  ...
  return (
    <MarketingInfoPage
      ...
      sections={[
        ...
        { id: "journal", title: "Journal and review", body: "Capture manual, simulated, or imported trades, review patterns, and turn trade history into repeatable process improvements." },
      ]}
    />
  );
}
